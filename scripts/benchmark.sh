...
# Sovereign Engine — hermetic crucible benchmark.
#
# Provisions the exact Go 1.26.1 toolchain used for the recorded core-microbench
# measurements (gate floor 50,736,038 ops/s on 32-core Graviton4; this tree
# re-measured 68,278,197 ops/s), builds the engine off the local toolchain,
...
readonly HERMETIC_ROOT="${SUPREMUM_HERMETIC_ROOT:-${HOME}/.supremum/hermetic}"
...
run_crucible() {
  ...
  # The authoritative gate is TestScalingGate; RUN_CRUCIBLE=1 enables the
  ...
  log "if the gate floor (50,736,038 ops/s on 32-core Graviton4) does not reproduce on equivalent silicon, the discrepancy is real"
}
