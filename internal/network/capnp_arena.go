...
// Package network implements the Cap'n Proto transport layer for the Sovereign
// Engine ingestion pipeline. This file provides the NewIngestionArena function
