...
// ---------------------------------------------------------------------------
// §2 Off-Heap Chaos Fuzzer — the violent C-space SIGSEGV injector
// ---------------------------------------------------------------------------
//
// Blueprint (§2): "The verification blueprint must introduce random
...
// the engine's own next Get/Set does, exactly mid-RPS as the design doc states.
//
