...
// trust pools). It is the shared setup for the three TLS gates.
...
// TestTLSHandshake_13_Only asserts the negotiated protocol is TLS 1.3
// and the cipher suite is in the 1.3 AEAD set. The Config Min==Max==1.3
// makes a 1.2/1.1/1.0 negotiation impossible — this test is the guard that
...
// TestTLSRejectWithoutClientCert asserts a dial with NO client cert
...
// TestTLSCertRotation_SIGHUP asserts that after writing a NEW leaf
