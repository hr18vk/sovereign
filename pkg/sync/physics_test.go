...
// ---------------------------------------------------------------------------
// — The Zero-GC Microscope (Ruthless Go Engine Verification Blueprint)
// ---------------------------------------------------------------------------
//
...
// ---------------------------------------------------------------------------
// — CPU Cache & False Sharing Profiling (AWS Graviton Crucible)
// ---------------------------------------------------------------------------
//
...
// TestFalseSharingProof is the CI gate for . It runs both
...
func TestFalseSharingProof(t *testing.T) {
	...
	fmt.Println()
	fmt.Println("╔══════════════════════════════════════════════════════════════╗")
	fmt.Println("║ FALSE SHARING PROOF — CACHE COHERENCE BENCHMARK ║")
	fmt.Println("╚══════════════════════════════════════════════════════════════╝")
...
// ---------------------------------------------------------------------------
// — Multi-Core Scaling Benchmark (DeltaCRDTEngine)
// ---------------------------------------------------------------------------
//
...
// count increases. It proves that the padding injected in
// allows the engine to scale linearly with core count.
//
// RUN: go test -bench=BenchmarkEngineScaling -benchmem./pkg/sync/
// ---------------------------------------------------------------------------

// BenchmarkEngineScalingUnpadded simulates the pre-padding layout by
...
// paddedEngineProxy mimics the post-padding DeltaCRDTEngine layout with
...
// multiple goroutines, simulating the pre-padding false sharing storm.
...
// multiple goroutines, demonstrating the post-padding cache-line isolation.
...
func TestEngineProxyFalseSharingProof(t *testing.T) {
	...
	fmt.Println()
	fmt.Println("╔══════════════════════════════════════════════════════════════════╗")
	fmt.Println("║ ENGINE PROXY FALSE SHARING PROOF ║")
	fmt.Println("╚══════════════════════════════════════════════════════════════════╝")
