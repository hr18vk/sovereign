...
//
// ZERO-GC MANDATE: The wrapper struct itself is allocated from
...
//
// PATH-COPYING + ZERO-GC CONTRACT (— Zero-GC Microscope):
//
...
// exposed for the Residency §2 chaos-probe (internal/chaos) so it can locate a
