...
// inflates the headline by GOMAXPROCS× — a fabrication caught in review).
//
...
// benchSiliconBatchSizes mirrors the amortization curve (N in {1,10,100,256}).
...
// BenchmarkBatchedVerifyParallel is the aggregate-throughput bench (the
...
//
// SCISSORS: in-process on the 4c benchmark box this is a CONSTRUCTION smoke (the
