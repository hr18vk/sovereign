...
// scraped at /metrics.
//
// The two physical facts that shape this package (see ADR-0008 §3):
//
...
// NOT sub-1us; the sub-1us-per-delta unlock is the batched-delta path.
package metrics
...
// The bucket boundaries are the bimodality guard — an operator reads the real
...
func NewRecorder(reg prometheus.Registerer) *Recorder {
	...
	// HELP/TYPE — the cold-start scrapeability gate asserts the seven series are scrapeable with
