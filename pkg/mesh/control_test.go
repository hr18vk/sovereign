...
// TestControlInsert_WALFailureReturns503 is the STEP-3b ACK-contract
// guard. It proves the handleInsert guard (control.go STEP-1): when the
...
func TestControlInsert_WALFailureReturns503(t *testing.T) {
	...
	// confirm the resulting dot is zero, else the guard guards the wrong thing.
...
// happy path. This is the red→green anchor: this guard is green at HEAD (pre-
...
// 503 guard's engine (NOT the rcvOriginNodeID — a fresh, self-consistent ID so
