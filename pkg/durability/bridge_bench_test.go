...
// LATENCY HONESTY. The bridge adds an AppendMutation fsync to the
...
// fsync) vs bare engine.InsertLocal ns/op, on the benchmark host
...
// fsync) — the baseline. The delta vs BenchmarkBridgePutLocal is the
