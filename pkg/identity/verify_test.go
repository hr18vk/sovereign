...
// torsion encodings fabrication-free with the exported edwards25519 API
// is mathematically obstructed:
...
// path requires either (a) a future change to land RFC 8032 §7.1 vectors
