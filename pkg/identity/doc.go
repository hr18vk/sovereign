...
// Package identity is the cryptographic identity layer of the Sovereign
...
// it inventories the three cryptographic bridges the roadmap pins
// for the cross-host provenance path.
//
// # ZIP-215 stance
//
// The standard library's crypto/ed25519 is banned for CRDT verification
// because of small-order torsion malleability. The
...
// pinned for preview-only use (build tag pq_preview); not exercised here.
// - github.com/koblas/cedar-go v0.1.0 — Cedar authorization evaluation,
// pinned for a latency experiment; not exercised here.
// - github.com/awslabs/aws-lc v1.73.0 (C library) — CGO bridge scaffold
// for hedged signing. The Go binding module
// github.com/aws/aws-lc-go is repo-not-found; the bridge targets the
// C library via #cgo directives. STUB only for now; real C
// linkage is future work.
//
// # Not yet implemented
//
// Hedged signing, the ML-DSA fallback, and the Cedar bench are not started
// here. Each carries its own gate; do not introduce a hedged-signing or
// ML-DSA claim without a go-doc-proven call site.
package identity
